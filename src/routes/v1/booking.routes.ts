...
router.post("/booking/create", auth.authenticate, (req, res) =>
  bookingController.createBooking(req, res),
);
router.put("/booking/payment/:id", auth.authenticate, (req, res) =>
  bookingController.processBookingPayment(req, res),
);
router.get("/booking/bookings", auth.authenticate, (req, res) =>
  bookingController.getAllBookings(req, res),
);
router.get("/booking/users/:userId", auth.authenticate, (req, res) =>
  bookingController.getBookingByUserId(req, res),
);

router.get("/booking/by-venue/:venueId/admin", auth.authenticate, (req, res) =>
  bookingController.getBookingByVenueId(req, res),
);
...
router.get("/booking/status-pending/:userId", auth.authenticate, (req, res) =>
  bookingController.getBookingPendingByUserId(req, res),
);

router.get("/booking/:id", (req, res) =>
  bookingController.getBookingById(req, res),
);
router.put("/booking/:id/cancel", auth.authenticate, (req, res) =>
  bookingController.cancelBooking(req, res),
);
router.put("/booking/:id/complete", auth.authenticate, (req, res) =>
